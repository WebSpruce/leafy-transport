...
public record GetRequest(string? Id, string? Email, string? FirstName, string? LastName, string? UserName, string? PhoneNumber, Guid? VehicleId, string? RoleName, DateTime? CreatedAt, Guid? ClientId, PaginationRequest? pagination);
